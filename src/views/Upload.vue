<template>
  <div v-if="respuesta">
    ...
    <div v-if="isLoading" class="mx-auto h-18 w-96">
      <p class="text-blue-600 font-bold m-auto text-center">
        CARGANDO A LA BASE DE DATOS, ESTE PROCESO PODRIA TOMAR UNOS MINUTOS
      </p>
    ...
    <div
      v-if="recapLink"
      class="mx-auto w-1/3 flex justify-center items-center"
    >
      <button
        class="
          cursor-pointer
